...
export function StreamingMessage() {
  ...
  return (
    <div className="flex items-start gap-[var(--space-3)] px-[var(--space-4)] py-[var(--space-2)]">
      ...
      <div className="max-w-[85%] rounded-[var(--radius-md)] bg-[var(--color-surface)] p-[var(--space-3)] text-[var(--color-text-primary)] text-[var(--font-size-body)] leading-[var(--line-height-body)] whitespace-pre-wrap break-words">
        {streamingContent}
