...
def run_tests():
    ...
    test_configs = [
        {"mode": "assistant", "modifier": "none", "query": "how should I approach fixing a flaky test?"},
        {"mode": "developer", "modifier": "none", "query": "how should I approach fixing a flaky test?"},
        {"mode": "research", "modifier": "none", "query": "how should I approach fixing a flaky test?"},
    ...
    with TestClient(app) as client:
        for config in test_configs:
            ...
            # Set settings
            set_resp = client.post("/settings", json={
